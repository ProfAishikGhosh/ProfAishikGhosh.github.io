...
---
- On the theory side, we accelerate and automate symbolic calculations using AI and high-performance computing to connect knowledge from across particle physics and cosmology. For instance, this approach has enabled us to uncover a wide range of novel [neutrino physics models](https://arxiv.org/abs/2506.08080). Recent work explores experimental signatures for dark matter.
